...
// Where it goes is a property of the FACE the browser resolved, not of the
// design, so it is measured at runtime by the shared probe, which the board's
// welcome card runs too. js/tittle-probe.js holds the method and the reasons.
trackTittle(document.querySelector('.hero__title'));
