...
const P = {
  ...
  // (An 'expand' mark, Feather 'maximize-2', lived here for one day. It marked
  // which cards open full screen; once the expand wave made that near enough
  // universal it repeated a known fact in every counting card's corner, so the
  // corner badge went text-only and the glyph lost its only caller: 2026-08-02.)
};
P.clear = P.sun;
P.cloudy = P.cloud;
