---
title: Landscapes
description: "A curated folder of landscape photography. Zero setup — add the card and it works."
---
...
**Settings → Landscapes.** Just the rotation interval — the folder is
built in.
