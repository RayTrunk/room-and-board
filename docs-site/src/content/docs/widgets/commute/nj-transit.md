---
title: NJ Transit
description: "Scheduled departures from New York Penn, filtered to the lines you ride, with delays arriving as alert banners."
---
...
**Tap the card** for the full departure board.

## Configure

**Settings → NJ Transit.** Filter to just the lines you ride — selecting none
means all of them. The alert banner can be toggled off.
